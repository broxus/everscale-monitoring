...
impl std::fmt::Display for ConfigMetrics {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        ...
        export_capabilities! {
            0x000001 => "IhrEnabled",
            0x000002 => "CreateStatsEnabled",
            0x000004 => "BounceMsgBody",
            0x000008 => "ReportVersion",
            0x000010 => "SplitMergeTransactions",
            0x000020 => "ShortDequeue",
            0x000040 => "MbppEnabled",
            0x000080 => "FastStorageStat",
            0x000100 => "InitCodeHash",
            0x000200 => "OffHypercube",
            0x000400 => "Mycode",
            0x000800 => "SetLibCode",
            0x001000 => "FixTupleIndexBug",
            0x002000 => "Remp",
            0x004000 => "Delections",
            0x010000 => "FullBodyInBounced",
            0x020000 => "StorageFeeToTvm",
            0x040000 => "Copyleft",
            0x080000 => "IndexAccounts",
            0x200000 => "TvmBugfixes2022",
            0x400000 => "Wc2WcQueueUpdates",
        }
